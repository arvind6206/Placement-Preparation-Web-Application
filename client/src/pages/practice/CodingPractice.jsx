...
export default function AptitudePractice() {
  ...
  const [answers, setAnswers] = useState(Array(codingQuestions.length).fill(null));
  const [submitted, setSubmitted] = useState(false);

  const q = codingQuestions[current];
  ...
  if (submitted) {
    const score = answers.filter((a, i) => a === codingQuestions[i].answer).length;
        ...
        <div className="flex-1 flex justify-center items-center">
          <div className="bg-white p-8 rounded-xl shadow text-center">
            ...
            <p className="text-3xl font-semibold text-blue-600">
              Score: {score} / {codingQuestions.length}
            </p>
      ...
      <div className="flex-1 p-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow">
          ...
          <div className="mt-6 flex justify-end">
            {current === codingQuestions.length - 1 ? (
              <button
